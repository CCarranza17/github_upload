...
print("The number of loans are", len(loan_costs))

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans
print('The sum of all loans is', sum(loan_costs))
...
print('The remaining amount of months on the loan is',remaining_months)
...
def pvcalc(fv,remaining,hurdle):
    pv = fv / (1 +(hurdle / 12)) ** remaining
    return pv

#Testing pvcalc
#print("PV2 is ",pvcalc(1000,12,.2))
...
print(f"The present value of the new loan is:", pvcalc(1000,12,.2))
